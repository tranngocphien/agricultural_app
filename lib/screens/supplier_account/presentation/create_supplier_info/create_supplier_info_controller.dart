...
class CreateSupplierInfoController extends BaseViewModel {
  final SupplierAccountService supplierAccountService;
  final ImagePickerService imagePickerService;

  CreateSupplierInfoController(
  ...
  Future<void> createSupplierInfo() async {
    if (validateData()) {
      ...
      await networkCall(
        supplierAccountService.createSupplierInfo(
        ...
        onSuccess: (data) {
          hideLoading();
          Get.back();
          Get.snackbar("Thông báo", "Đăng ký trở thành nhà cung cấp thành công");
        },
      );
    }
  }
