...
import 'create_supplier_info_controller.dart';

class CreateSupplierInfoScreen extends BaseView<CreateSupplierInfoController> {
  ...
  Widget buildPage(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: AppText(
          text: "Đăng ký thông tin nhà cung cấp",
          color: AppColors.black,
          fontSize: 18,
      ...
      body: Column(
        children: [
          ...
          InkWell(
            onTap: () async {
              await controller.createSupplierInfo();
            },
            child: Container(
                padding: EdgeInsets.all(16),
                child: Container(
